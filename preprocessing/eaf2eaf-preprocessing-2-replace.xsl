...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="TIER[@LINGUISTIC_TYPE_REF='gr-gls-ru']//ANNOTATION_VALUE/text()">
        <xsl:variable name="text-next" select="if (ancestor::ANNOTATION/following-sibling::ANNOTATION[1]//ANNOTATION_VALUE/text())
    ...
    <xsl:template match="TIER[@LINGUISTIC_TYPE_REF='mb-cf-enh']//ANNOTATION">
